...
func TestConfigure_ListAndDelete(t *testing.T) {
	...
	run("configure", "set", "--profile", "tenant-a-cn", "--ak", "akA", "--sk", "skA", "--region", "cn-beijing")
	run("configure", "set", "--profile", "tenant-b-cn", "--ak", "akB", "--sk", "skB", "--region", "cn-beijing")
...
func TestConfigure_DeletePrefixRequiresYes(t *testing.T) {
	...
	runOK("configure", "set", "--profile", "tenant-a-cn", "--ak", "akA", "--sk", "skA", "--region", "cn-beijing")
	runOK("configure", "set", "--profile", "tenant-a-sg", "--ak", "akA", "--sk", "skA", "--region", "ap-singapore-1")
